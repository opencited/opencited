...
export const pageAnalysisUpsertBatchInputSchema = z.object({
	analyses: z.array(
		z.object({
...
export const pageAnalysisUpsertBatchOutputSchema = z.object({
	upserted: z.number(),
});

export const pageAnalysisUpsertBatchContextSchema = baseActionContextSchema;
...
export const pageAnalysisUpsertBatchAction = async (params: {
	input: z.infer<typeof pageAnalysisUpsertBatchInputSchema>;
	ctx: z.infer<typeof pageAnalysisUpsertBatchContextSchema>;
}) => {
...
export const pageAnalysisUpsertBatchHandler = async (params: {
	input: z.infer<typeof pageAnalysisUpsertBatchInputSchema>;
	ctx: z.infer<typeof pageAnalysisUpsertBatchContextSchema>;
}) => {
	return pageAnalysisUpsertBatchAction(params);
};
